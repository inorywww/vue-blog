              ...
              <el-form :model="releaseForm" :rules="formRules" ref="releaseForm">
                     <div class="form-row">
                        <el-form-item label="内容" label-width="120px" prop="content">
                            <el-input type="textarea" v-model="releaseForm.content" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="封面" label-width="120px" prop="coverSrc" class="upload-container">
                            <el-input v-model="releaseForm.coverSrc" autocomplete="off"></el-input>
